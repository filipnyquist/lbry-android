...
public class ExchangeHistoryProvider extends ContentProvider {
    ...
    public static class ExchangeEntry implements Serializable {
        ...
        public ExchangeEntry(int status, @Nonnull AbstractAddress depositAddress,
            ...
            this.status = status;
            this.depositAddress = Preconditions.checkNotNull(depositAddress);
            this.depositAmount = Preconditions.checkNotNull(depositAmount);
            this.depositTransactionId = Preconditions.checkNotNull(depositTransactionId);
        ...
        public ExchangeEntry(ExchangeEntry initialEntry, ShapeShiftTxStatus txStatus) {
            ...
            this.depositAddress = Preconditions.checkNotNull(txStatus.address == null ?
                    initialEntry.depositAddress : txStatus.address);
            this.depositAmount = Preconditions.checkNotNull(txStatus.incomingValue == null ?
                    initialEntry.depositAmount : txStatus.incomingValue);
            this.depositTransactionId = Preconditions.checkNotNull(initialEntry.depositTransactionId);
