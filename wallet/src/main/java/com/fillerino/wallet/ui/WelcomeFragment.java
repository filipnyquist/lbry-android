...
public class WelcomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.fillerino.wallet.R.layout.fragment_welcome, container, false);

        view.findViewById(com.fillerino.wallet.R.id.create_wallet).setOnClickListener(getOnCreateListener());
        view.findViewById(com.fillerino.wallet.R.id.restore_wallet).setOnClickListener(getOnRestoreListener());
