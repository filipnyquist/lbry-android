...
import com.fillerino.core.wallet.WalletConnectivityStatus;
...
import com.fillerino.wallet.ui.widget.Amount;
import com.fillerino.wallet.ui.widget.SwipeRefreshLayout;
...
public class BalanceFragment extends WalletFragment implements LoaderCallbacks<List<AbstractTransaction>> {
    ...
    private final ContentObserver addressBookObserver = new AddressBookObserver(handler);
            ...
            @Bind(com.fillerino.wallet.R.id.transaction_rows) ListView transactionRows;
    @Bind(com.fillerino.wallet.R.id.swipeContainer)
    SwipeRefreshLayout swipeContainer;
    @Bind(com.fillerino.wallet.R.id.history_empty) View emptyPocketMessage;
    @Bind(com.fillerino.wallet.R.id.account_balance)
    Amount accountBalance;
    @Bind(com.fillerino.wallet.R.id.account_exchanged_balance) Amount accountExchangedBalance;
    @Bind(com.fillerino.wallet.R.id.connection_label) TextView connectionLabel;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // The onCreateOptionsMenu is handled in AccountFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.fillerino.wallet.R.layout.fragment_balance, container, false);
    ...
    private void setupSwipeContainer() {
        ...
        swipeContainer.setColorSchemeResources(
                com.fillerino.wallet.R.color.progress_bar_color_1,
                com.fillerino.wallet.R.color.progress_bar_color_2,
                com.fillerino.wallet.R.color.progress_bar_color_3,
                com.fillerino.wallet.R.color.progress_bar_color_4);
    }

    private void addHeaderAndFooterToList(LayoutInflater inflater, ViewGroup container, View view) {
        ListView list = ButterKnife.findById(view, com.fillerino.wallet.R.id.transaction_rows);

        // Initialize header
        View header = inflater.inflate(com.fillerino.wallet.R.layout.fragment_balance_header, null);
        ...
        listFooter.setMinimumHeight(
                getResources().getDimensionPixelSize(com.fillerino.wallet.R.dimen.activity_vertical_margin));
    ...
    @OnItemClick(com.fillerino.wallet.R.id.transaction_rows)
    public void onItemClick(int position) {
        if (position >= transactionRows.getHeaderViewsCount()) {
            ...
            if (obj != null && obj instanceof AbstractTransaction) {
                ...
                Toast.makeText(getActivity(), getString(com.fillerino.wallet.R.string.get_tx_info_error), Toast.LENGTH_LONG).show();
            }
        }
    }

    @OnClick(com.fillerino.wallet.R.id.account_balance)
    public void onMainAmountClick() {
        isFullAmount = !isFullAmount;
        updateView();
    }

    @OnClick(com.fillerino.wallet.R.id.account_exchanged_balance)
