...
public final class EditAccountFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        final WalletAccount account = Preconditions.checkNotNull(app.getAccount(args.getString(ARG_ACCOUNT_ID)));
        final LayoutInflater inflater = LayoutInflater.from(context);
        final DialogBuilder dialog = new DialogBuilder(context);
        final View view = inflater.inflate(com.fillerino.wallet.R.layout.edit_account_dialog, null);
        final EditText descriptionView = ButterKnife.findById(view, com.fillerino.wallet.R.id.edit_account_description);
        descriptionView.setText(account.getDescription());
        descriptionView.setHint(account.getCoinType().getName());

        dialog.setTitle(com.fillerino.wallet.R.string.edit_account_title);
        dialog.setView(view);
        ...
        dialog.setPositiveButton(com.fillerino.wallet.R.string.button_save, onClickListener);
        dialog.setNegativeButton(com.fillerino.wallet.R.string.button_cancel, onClickListener);
