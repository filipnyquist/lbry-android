package com.fillerino.wallet.ui.adaptors;
...
public class AccountListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View row, final ViewGroup parent) {
        if (row == null) row = inflater.inflate(com.fillerino.wallet.R.layout.account_row, null);
    ...
    private void bindView(View row, WalletAccount account) {
        final ImageView icon = (ImageView) row.findViewById(com.fillerino.wallet.R.id.account_icon);
        icon.setImageResource(Constants.COINS_ICONS.get(account.getCoinType()));

        final TextView rowLabel = (TextView) row.findViewById(com.fillerino.wallet.R.id.account_description);
        rowLabel.setText(account.getDescriptionOrCoinName());

        final Amount rowValue = (Amount) row.findViewById(com.fillerino.wallet.R.id.account_balance);
        ...
        final Amount rowBalanceRateValue = (Amount) row.findViewById(com.fillerino.wallet.R.id.account_balance_rate);
        ...
        final Amount rowRateValue = (Amount) row.findViewById(com.fillerino.wallet.R.id.exchange_rate_row_rate);
        if (rate != null && account.getCoinType() != null) {
