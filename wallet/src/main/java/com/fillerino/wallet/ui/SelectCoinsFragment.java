...
import com.fillerino.wallet.ui.widget.HeaderWithFontIcon;
...
public class SelectCoinsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.fillerino.wallet.R.layout.fragment_select_coins_list, container, false);
        ...
        coinList = (ListView) view.findViewById(com.fillerino.wallet.R.id.coins_list);
        // Set header if needed
        if (message != null) {
            HeaderWithFontIcon header = new HeaderWithFontIcon(context);
            header.setFontIcon(com.fillerino.wallet.R.string.font_icon_coins);
            header.setMessage(com.fillerino.wallet.R.string.select_coins);
            coinList.addHeaderView(header, null, false);
        } else {
            View topPaddingView = new View(context);
            topPaddingView.setMinimumHeight(getResources().getDimensionPixelSize(com.fillerino.wallet.R.dimen.half_standard_margin));
