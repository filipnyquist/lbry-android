...
public class AddressesListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View row, final ViewGroup parent) {
        if (row == null) {
            row = inflater.inflate(com.fillerino.wallet.R.layout.address_row, null);
        }
    ...
    public void bindView(@Nonnull final View row, @Nonnull final AbstractAddress address) {
        TextView addressLabel = (TextView) row.findViewById(com.fillerino.wallet.R.id.address_row_label);
        TextView addressRaw = (TextView) row.findViewById(com.fillerino.wallet.R.id.address_row_address);
        ...
        TextView addressUsageLabel = (TextView) row.findViewById(com.fillerino.wallet.R.id.address_row_usage);
        TextView addressUsageFontIcon = (TextView) row.findViewById(com.fillerino.wallet.R.id.address_row_usage_font_icon);
        Fonts.setTypeface(addressUsageFontIcon, Fonts.Font.COINOMI_FONT_ICONS);

        if (usedAddresses.contains(address)) {
            addressUsageLabel.setText(com.fillerino.wallet.R.string.previous_addresses_used);
            addressUsageFontIcon.setText(com.fillerino.wallet.R.string.font_icon_receive_coins);
            addressUsageFontIcon.setBackgroundResource(com.fillerino.wallet.R.drawable.address_row_circle_bg_used);
        } else {
            addressUsageLabel.setText(com.fillerino.wallet.R.string.previous_addresses_unused);
            addressUsageFontIcon.setText(com.fillerino.wallet.R.string.font_icon_check);
            addressUsageFontIcon.setBackgroundResource(com.fillerino.wallet.R.drawable.address_row_circle_bg_unused);
        }
    }
