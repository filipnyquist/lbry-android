...
import com.fillerino.core.exceptions.UnsupportedCoinTypeException;
...
import com.fillerino.wallet.ui.dialogs.CreateNewAddressDialog;
...
import static com.fillerino.wallet.ExchangeRatesProvider.getRate;
...
public class AddressRequestFragment extends WalletFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // or in PreviousAddressesActivity
        ...
        // TODO
        account = Preconditions.checkNotNull(walletApplication.getAccount(accountId));
        if (account == null) {
