...
public class FinalizeWalletRestorationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.fillerino.wallet.R.layout.fragment_finalize_wallet_restoration, container, false);
        status = (TextView) view.findViewById(com.fillerino.wallet.R.id.restoration_status);
        return view;
    }
            ...
            switch (msg.what) {
                case RESTORE_STATUS_UPDATE:
                    ...
                    if (workingOn.isEmpty()) {
                        ref.status.setText(ref.getString(com.fillerino.wallet.R.string.wallet_restoration_master_key));
                    } else {
                        ref.status.setText(ref.getString(com.fillerino.wallet.R.string.wallet_restoration_coin, workingOn));
                    }
                    break;
                case RESTORE_FINISHED:
                    ...
                    if (task.wallet != null) {
                        ...
                        String errorMessage = ref.getResources().getString(
                                com.fillerino.wallet.R.string.wallet_restoration_error, task.errorMessage);
