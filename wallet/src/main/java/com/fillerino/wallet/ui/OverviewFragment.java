...
import com.fillerino.wallet.ui.adaptors.AccountListAdapter;
...
public class OverviewFragment extends Fragment{
    ...
    @Bind(com.fillerino.wallet.R.id.account_rows) ListView accountRows;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNavigationDrawerFragment = (NavigationDrawerFragment)
                getFragmentManager().findFragmentById(com.fillerino.wallet.R.id.navigation_drawer);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.fillerino.wallet.R.layout.fragment_overview, container, false);
        View header = inflater.inflate(com.fillerino.wallet.R.layout.fragment_overview_header, null);
        accountRows = ButterKnife.findById(view, com.fillerino.wallet.R.id.account_rows);
        ...
        listFooter.setMinimumHeight(getResources().getDimensionPixelSize(com.fillerino.wallet.R.dimen.activity_vertical_margin));
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        if (mNavigationDrawerFragment != null && !mNavigationDrawerFragment.isDrawerOpen()) {
            inflater.inflate(com.fillerino.wallet.R.menu.overview, menu);
        }
    }
    ...
    @OnItemClick(com.fillerino.wallet.R.id.account_rows)
    ...
    @OnItemLongClick(com.fillerino.wallet.R.id.account_rows)
    ...
    private void showGenericError() {
        Toast.makeText(getActivity(), getString(com.fillerino.wallet.R.string.error_generic), Toast.LENGTH_LONG).show();
    }
