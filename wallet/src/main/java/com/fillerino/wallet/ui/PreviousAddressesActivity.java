...
public class PreviousAddressesActivity extends BaseWalletActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(com.fillerino.wallet.R.id.container, addressesList, LIST_ADDRESSES_TAG)
                    .commit();
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (f != null && f.isVisible()) {
            getMenuInflater().inflate(com.fillerino.wallet.R.menu.request_single_address, menu);
            return true;
        }
    ...
    public void onAddressSelected(Bundle args) {
        replaceFragment(AddressRequestFragment.newInstance(args), com.fillerino.wallet.R.id.container, ADDRESS_TAG);
    }
}
