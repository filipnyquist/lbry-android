...
//        builder.setIcon(R.drawable.ic_menu_warning);
    ...
    public DialogBuilder(final Context context) {
        ...
        this.customTitle = LayoutInflater.from(context).inflate(com.fillerino.wallet.R.layout.dialog_title, null);
    ...
    public DialogBuilder singleDismissButton(@Nullable final OnClickListener dismissListener) {
        setNeutralButton(com.fillerino.wallet.R.string.button_dismiss, dismissListener);
