...
import static com.fillerino.wallet.util.UiUtils.toastGenericError;
...
public class AccountFragment extends Fragment {
    ...
    @Bind(com.fillerino.wallet.R.id.pager) ViewPager viewPager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(com.fillerino.wallet.R.layout.fragment_account, container, false);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        if (mNavigationDrawerFragment != null && !mNavigationDrawerFragment.isDrawerOpen() &&
            ...
            switch (viewPager.getCurrentItem()) {
                case RECEIVE:
                    inflater.inflate(com.fillerino.wallet.R.menu.request, menu);
                    MenuItem newAddressItem = menu.findItem(com.fillerino.wallet.R.id.action_new_address);
                    if (newAddressItem != null) {
                        newAddressItem.setVisible(account.canCreateNewAddresses());
                    }
                    break;
                case BALANCE:
                    inflater.inflate(com.fillerino.wallet.R.menu.balance, menu);
                    // Disable sign/verify for coins that don't support it
                    menu.findItem(com.fillerino.wallet.R.id.action_sign_verify_message)
                            .setVisible(account.getCoinType().canSignVerifyMessages());
                    break;
                case SEND:
                    inflater.inflate(com.fillerino.wallet.R.menu.send, menu);
                    break;
            }
        }
    }
        ...
        if (f != null) {
            try {
                ...
                Toast.makeText(getContext(),
                        getString(com.fillerino.wallet.R.string.scan_error, e.getMessage()),
    ...
    private static class AppSectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public AppSectionsPagerAdapter(Context context, FragmentManager fm, WalletAccount account) {
            super(fm);
            receiveTitle = context.getString(com.fillerino.wallet.R.string.wallet_title_request);
            sendTitle = context.getString(com.fillerino.wallet.R.string.wallet_title_send);
            balanceTitle = context.getString(com.fillerino.wallet.R.string.wallet_title_balance);
