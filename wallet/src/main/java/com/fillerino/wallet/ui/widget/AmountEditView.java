...
import com.fillerino.wallet.util.MonetarySpannable;
...
public class AmountEditView extends LinearLayout {
    ...
    public AmountEditView(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(com.fillerino.wallet.R.layout.amount_edit, this, true);

        LinearLayout layout = (LinearLayout) findViewById(com.fillerino.wallet.R.id.amount_layout);
