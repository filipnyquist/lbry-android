...
public class ShowSeedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.fillerino.wallet.R.layout.fragment_show_seed, container, false);

        seedLayout = view.findViewById(com.fillerino.wallet.R.id.show_seed_layout);
        seedEncryptedLayout = view.findViewById(com.fillerino.wallet.R.id.seed_encrypted_layout);
        ...
        seedView = (TextView) view.findViewById(com.fillerino.wallet.R.id.seed);
        seedPasswordProtectedView = view.findViewById(com.fillerino.wallet.R.id.seed_password_protected);
        Fonts.setTypeface(view.findViewById(com.fillerino.wallet.R.id.seed_password_protected_lock), Fonts.Font.COINOMI_FONT_ICONS);
        qrView = (ImageView) view.findViewById(com.fillerino.wallet.R.id.qr_code_seed);

        TextView lockIcon = (TextView) view.findViewById(com.fillerino.wallet.R.id.lock_icon);
    ...
    private class LoadSeedTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            Dialogs.ProgressDialogFragment.show(getFragmentManager(),
                    getString(com.fillerino.wallet.R.string.seed_working), SEED_PROCESSING_DIALOG_TAG);
        }
