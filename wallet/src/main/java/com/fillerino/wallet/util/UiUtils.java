...
import com.fillerino.wallet.ui.AccountDetailsActivity;
import com.fillerino.wallet.ui.EditAccountFragment;
import com.fillerino.wallet.ui.EditAddressBookEntryFragment;
...
public class UiUtils {
    ...
    static public void toastGenericError(Context context) {
        Toast.makeText(context, com.fillerino.wallet.R.string.error_generic, Toast.LENGTH_LONG).show();
    }
    ...
    static public void replyAddressRequest(Activity activity, CoinURI uri, WalletAccount pocket) throws CoinURIParseException {
        try {
            ...
            Toast.makeText(activity, com.fillerino.wallet.R.string.error_generic, Toast.LENGTH_LONG).show();
        }
    }
    ...
    public static void copy(Context context, String string) {
        ...
        try {
            ...
            Toast.makeText(context, com.fillerino.wallet.R.string.copied_to_clipboard, Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
    ...
    public static class AddressActionModeCallback implements ActionMode.Callback {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            mode.getMenuInflater().inflate(com.fillerino.wallet.R.menu.address_options, menu);
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case com.fillerino.wallet.R.id.action_edit_label:
                    EditAddressBookEntryFragment.edit(fragmentManager, address);
                    mode.finish();
                    return true;
                case com.fillerino.wallet.R.id.action_copy:
    ...
    public static class CopyShareActionModeCallback implements ActionMode.Callback {
        ...
        @Override
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            mode.getMenuInflater().inflate(com.fillerino.wallet.R.menu.copy_share_options, menu);
            return true;
        }
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case com.fillerino.wallet.R.id.action_share:
    ...
    public static class AccountActionModeCallback implements ActionMode.Callback {
        ...
        @Override
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            mode.getMenuInflater().inflate(com.fillerino.wallet.R.menu.account_options, menu);
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case com.fillerino.wallet.R.id.action_edit_description:
                    EditAccountFragment.edit(fragmentManager, account);
                    mode.finish();
                    return true;
                case com.fillerino.wallet.R.id.action_account_details:
                ...
                case com.fillerino.wallet.R.id.action_delete:
                    new AlertDialog.Builder(activity)
                            .setTitle(activity.getString(com.fillerino.wallet.R.string.edit_account_delete_title,
                                    account.getDescriptionOrCoinName()))
                            .setMessage(com.fillerino.wallet.R.string.edit_account_delete_description)
