package com.fillerino.core.wallet.families.vpncoin;
...
public class VpncoinTxMessage implements TxMessage {
    ...
    public void setFrom(String from) {
        Preconditions.checkArgument(from.length() <= MAX_TX_DATA_FROM, "'From' field size exceeded");
        this.from = from;
    }

    public void setSubject(String subject) {
        Preconditions.checkArgument(subject.length() <= MAX_TX_DATA_SUBJ, "'Subject' field size exceeded");
        this.subject = subject;
    }

    public void setMessage(String message) {
        Preconditions.checkArgument(message.length() <= MAX_TX_DATA_MSG, "'Message' field size exceeded");
    ...
    static VpncoinTxMessage parseUnencrypted(String fullMessage) throws Exception {
        Preconditions.checkArgument(fullMessage.length() <= MAX_TX_DATA, "Maximum data size exceeded");
