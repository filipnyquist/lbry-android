...
import com.fillerino.core.coins.nxt.NxtException;
...
import com.fillerino.core.network.NxtServerClient;
...
import com.fillerino.core.util.KeyUtils;
...
import com.fillerino.core.wallet.WalletAccountEventListener;
...
//        throw new RuntimeException("Not implemented");
    ...
    public NxtSendRequest sendCoinsOffline(NxtAddress address, Value amount, @Nullable String password)
        ...
        if (password != null) {
            ...
            key = Preconditions.checkNotNull(getKeyCrypter()).deriveKey(password);
        }
