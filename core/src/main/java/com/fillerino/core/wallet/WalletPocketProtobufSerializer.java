...
import com.fillerino.core.wallet.families.bitcoin.EmptyTransactionOutput;
import com.fillerino.core.wallet.families.bitcoin.TrimmedTransaction;
import com.fillerino.core.wallet.families.bitcoin.TrimmedOutput;
    ...
    private static Protos.Transaction makeBitTxProto(BitWalletTransaction wtx) {
        ...
        for (TransactionOutput output : tx.getOutputs()) {
            ...
            if (output instanceof EmptyTransactionOutput) {
                Preconditions.checkState(isTrimmed, "Transaction contains empty outputs but is not trimmed");
                index++;
                continue;
            }
        ...
        for (Protos.TransactionOutput outputProto : txProto.getTransactionOutputList()) {
            ...
            if (isTrimmed) {
                if (needsOutputIndexes) {
                    ...
                    Preconditions.checkState(outputProto.getIndex() > lastIndex, "Output index is not in the correct order");
