...
import com.fillerino.core.coins.nxt.Account;
...
//        nxtTx.sign(nxtSecret);
        ...
        Assert.assertEquals(Attachment.ORDINARY_PAYMENT, parsedTx.getAttachment());
...
//        System.out.println(Convert.toHexString(nxtTx.getBytes()));
    ...
    public void testSerializeKeychainToProtobuf() throws UnreadableWalletException
    {
        ...
        Assert.assertEquals(nxtAccount.getId(), newWallet.getId());
