package com.fillerino.core.coins.nxt;
...
import com.fillerino.core.wallet.families.nxt.NxtFamilyKey;
...
public class NxtFamilyTest {
    ...
    public void testNxtMessageTransaction() throws NxtException.ValidationException {
        ...
        Appendix.EncryptedMessage msg = new Appendix.EncryptedMessage(data, true);
